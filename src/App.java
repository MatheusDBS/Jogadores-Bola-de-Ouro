...
public class App {
    public static void main(String[] args) {
        // Variável para armazenar a opção do menu escolhida pelo usuário, inicializada
        // com -1 para iniciar o loop
        int opcaoMenu = -1;

        // Criação de instâncias das várias classes que gerenciam diferentes
        ...
        // Loop para manter a aplicação em execução até que o usuário escolha sair
        // (opção 0)
        while (opcaoMenu != 0) {
            ...
            switch (menuUsuario.exibeMenu()) {
                ...
                case 2:
                    ...
                    // Caso para listar os principais países e jogadores com mais prêmios de Bola de
                    // Ouro
                case 3:
